...
def query_rag(chat_history: list):
    """
    Given the full chat history, retrieves top documents and generates a response using Groq LLM.
    """
    user_query = chat_history[-1]['content']  # Last user input (assumes well-formed history)
