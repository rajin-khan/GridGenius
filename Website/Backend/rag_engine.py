...
async def query_rag(chat_history: List[Dict[str, str]]) -> AsyncGenerator[str, None]:
    ...
    try:
        ...
        system_prompt = (
            ...
            "I aim to be clear and helpful, maintaining natural conversation flow, stating how impactful and amazing the project is, while presenting information in a fun and concise way when possible, and expanding when needed **When presenting data examples or comparisons, please use Markdown table format for clarity.**\n\n"
